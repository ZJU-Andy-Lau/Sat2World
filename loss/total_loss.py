...
class RPCAnySplatTrainingObjective:
    ...
    def forward(
        ...
        scalar_dict: dict[str, Any] = {
            ...
            "metric_feature_nce_input_nonfinite_ratio": p_nce.get("feature_nce_input_nonfinite_ratio", zero),
            "metric_feature_nce_anchor_nonfinite_ratio": p_nce.get("feature_nce_anchor_nonfinite_ratio", zero),
            "metric_feature_nce_positive_nonfinite_ratio": p_nce.get("feature_nce_positive_nonfinite_ratio", zero),
            "metric_feature_nce_logits_nonfinite_ratio": p_nce.get("feature_nce_logits_nonfinite_ratio", zero),
            "metric_feature_nce_num_directions_total": p_nce.get("feature_nce_num_directions_total", zero),
            "metric_feature_nce_num_directions_zero_overlap": p_nce.get("feature_nce_num_directions_zero_overlap", zero),
            "metric_feature_nce_num_directions_used": p_nce.get("feature_nce_num_directions_used", zero),
            ...
            "metric_patch_match_input_nonfinite_ratio": p_patch_match.get("patch_match_input_nonfinite_ratio", zero),
            "metric_patch_match_src_nonfinite_ratio": p_patch_match.get("patch_match_src_nonfinite_ratio", zero),
            "metric_patch_match_ref_nonfinite_ratio": p_patch_match.get("patch_match_ref_nonfinite_ratio", zero),
            "metric_patch_match_logits_nonfinite_ratio": p_patch_match.get("patch_match_logits_nonfinite_ratio", zero),
            "metric_patch_match_num_directions_total": p_patch_match.get("patch_match_num_directions_total", zero),
            "metric_patch_match_num_directions_zero_overlap": p_patch_match.get("patch_match_num_directions_zero_overlap", zero),
            "metric_patch_match_num_directions_used": p_patch_match.get("patch_match_num_directions_used", zero),
