...
class MultiViewFeatureTransformer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        concat0, concat1 = batch_features(multi_view_features) # concat0表示轮流作主视角的ref_fea；concat1表示与之对应的src_fea
        ...
        for i, layer in enumerate(self.layers):
            ...
            if i < len(self.layers) - 1:
                ...
                concat0, concat1 = batch_features(features) # 通过layer(corss_Transformer)，将src_fea融合到ref_fea中。由于ref和src都是哪那些影像，只不过是轮流来的，故concat0表示轮流作主视角的ref_fea；concat1表示与之对应的src_fea
        ...
        return features # cross_view的信息通过transformer融合完毕
